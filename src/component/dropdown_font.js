...
var DropdownFont = /*#__PURE__*/function (_Dropdown) {
  ...
  function DropdownFont() {
    ...
    var nfonts = _font.baseFonts.map(function (it) {
    ...
    return _this = _possibleConstructorReturn(this, (_ref = DropdownFont.__proto__ || Object.getPrototypeOf(DropdownFont)).call.apply(_ref, [this, _font.baseFonts[0].title, '160px', true, 'bottom-left'].concat(_toConsumableArray(nfonts))));
  }
