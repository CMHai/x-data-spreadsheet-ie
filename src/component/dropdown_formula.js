...
var DropdownFormula = /*#__PURE__*/function (_Dropdown) {
  ...
  function DropdownFormula() {
    ...
    var nformulas = _formula.baseFormulas.map(function (it) {
    ...
    return _this = _possibleConstructorReturn(this, (_ref = DropdownFormula.__proto__ || Object.getPrototypeOf(DropdownFormula)).call.apply(_ref, [this, new _icon["default"]('formula'), '180px', true, 'bottom-left'].concat(_toConsumableArray(nformulas))));
  }
