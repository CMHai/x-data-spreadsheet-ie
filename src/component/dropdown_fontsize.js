...
var DropdownFontSize = /*#__PURE__*/function (_Dropdown) {
  ...
  function DropdownFontSize() {
    ...
    var nfontSizes = _font.fontSizes.map(function (it) {
    ...
    return _this = _possibleConstructorReturn(this, (_ref = DropdownFontSize.__proto__ || Object.getPrototypeOf(DropdownFontSize)).call.apply(_ref, [this, '10', '60px', true, 'bottom-left'].concat(_toConsumableArray(nfontSizes))));
  }
