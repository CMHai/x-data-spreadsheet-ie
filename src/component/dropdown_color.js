...
var DropdownColor = /*#__PURE__*/function (_Dropdown) {
  ...
  function DropdownColor(iconName, color) {
    ...
    var icon = new _icon["default"](iconName).css('height', '16px').css('border-bottom', "3px solid ".concat(color));
    var colorPalette = new _color_palette["default"]();
    ...
    return _this = _possibleConstructorReturn(this, (DropdownColor.__proto__ || Object.getPrototypeOf(DropdownColor)).call(this, icon, 'auto', false, 'bottom-left', colorPalette.el));
  }
